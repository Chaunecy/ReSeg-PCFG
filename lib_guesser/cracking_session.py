...
class CrackingSession:
    ...
    def run(self, load_session=False):
        ...
        while True:
            ...
            if pt_item is None or self.pcfg.guesses_generate_done:
        ...
        if duration <= 0.000001:
            duration = 0.000001
            print("time use is to short")
        print(f"{self.pcfg.guess_number / duration}items/sec, time used is {duration}")
        return
